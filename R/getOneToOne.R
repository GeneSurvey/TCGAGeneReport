...
getOneToOne_UCSC_List <- function(theZipFile="/rsrch1/bcb/batcheffects/GENE_REPORT/GeneSurvey.zip", theVerboseFlag=FALSE)
{
	getOneToOne_List_internal(theZipFile, 'getOneToOne_UCSC_List', theVerboseFlag=theVerboseFlag)
}

getOneToOne_GeneSymbol_List <- function(theZipFile="/rsrch1/bcb/batcheffects/GENE_REPORT/GeneSurvey.zip", theVerboseFlag=FALSE)
{
	getOneToOne_List_internal(theZipFile, 'getOneToOne_GeneSymbol_List', theVerboseFlag=theVerboseFlag)
}

getOneToOne_GeneSymbol_UCID <- function(theUCIDId, theZipFile="/rsrch1/bcb/batcheffects/GENE_REPORT/GeneSurvey.zip", theVerboseFlag=FALSE)
{
	getOneToOne_Name_internal(theUCIDId, theZipFile, 'getOneToOne_GeneSymbol_UCID', theVerboseFlag=theVerboseFlag)
}

getOneToOne_UCID_GeneSymbol <- function(theGeneSymbol, theZipFile="/rsrch1/bcb/batcheffects/GENE_REPORT/GeneSurvey.zip", theVerboseFlag=FALSE)
{
